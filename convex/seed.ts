...
export const seed = mutation({
  handler: async (ctx) => {
    ...
    const testimonials = [
      { name: "James Otieno", role: "Legal Firm Partner", text: "LegalFlow replaced three separate tools we were using. Matter tracking, billing, and client communication in one place.", avatar: "https://i.pravatar.cc/80?u=james-otieno-ke", rating: 5, isApproved: true },
      { name: "Grace Wanjiku", role: "Education Director", text: "CodeMaster is exactly what our students needed. The structured approach to learning coding is unmatched.", avatar: "https://i.pravatar.cc/80?u=grace-wanjiku-ke", rating: 5, isApproved: true },
      { name: "Kevin Mwangi", role: "Car Rental Entrepreneur", text: "Finding and booking a car through CarSoko was seamless. The platform is intuitive and the service professional.", avatar: "https://i.pravatar.cc/80?u=kevin-mwangi-ke", rating: 5, isApproved: true },
      { name: "Faith Nyambura", role: "Startup Founder", text: "Working with the team was seamless. They understood our needs, delivered on time, and communicated clearly.", avatar: "https://i.pravatar.cc/80?u=fai̊th-nyambura-ke", rating: 5, isApproved: true },
      { name: "Peter Kamau", role: "Tech Company CEO", text: "The software solution transformed our operations. We've seen a 40% increase in efficiency since implementation.", avatar: "https://i.pravatar.cc/80?u=peter-kamau-ke", rating: 5, isApproved: true },
      { name: "Nancy Akinyi", role: "Marketing Manager", text: "The platform design is intuitive and beautiful. Our customers love the new experience.", avatar: "https://i.pravatar.cc/80?u=nancy-akinyi-ke", rating: 5, isApproved: true },
      { name: "Samuel Kiprop", role: "IT Director", text: "System integration was seamless and the training provided was top-notch. Highly recommended.", avatar: "https://i.pravatar.cc/80?u=samuel-kiprop-ke", rating: 5, isApproved: true },
      { name: "Diana Wambui", role: "Non-Profit Lead", text: "We needed a platform that could scale with our growing community. The solution delivered beyond expectations.", avatar: "https://i.pravatar.cc/80?u=diana-wambui-ke", rating: 5, isApproved: true },
      { name: "Brian Omondi", role: "E-commerce Owner", text: "Sales have doubled since the new site launched. The user experience is smooth and the checkout flow is flawless.", avatar: "https://i.pravatar.cc/80?u=brian-omondi-ke", rating: 5, isApproved: true },
      { name: "Catherine Njeri", role: "University Admin", text: "The learning management system revolutionized how we deliver education. Students and faculty both love it.", avatar: "https://i.pravatar.cc/80?u=catherine-njeri-ke", rating: 5, isApproved: true },
      { name: "David Muthomi", role: "Healthcare Executive", text: "Patient management has never been easier. The system is reliable, secure, and our staff adapted quickly.", avatar: "https://i.pravatar.cc/80?u=david-muthomi-ke", rating: 5, isApproved: true },
      { name: "Esther Chebet", role: "Event Coordinator", text: "The booking platform streamlined our entire process. We've reduced no-shows by 60%.", avatar: "https://i.pravatar.cc/80?u=esther-chebet-ke", rating: 5, isApproved: true },
      { name: "Francis Njoroge", role: "Real Estate Agent", text: "Property listings now look stunning online. The virtual tour integration was a game-changer.", avatar: "https://i.pravatar.cc/80?u=francis-njoroge-ke", rating: 5, isApproved: true },
      { name: "Gladys Jeruto", role: "Banking Consultant", text: "Security and reliability were our top concerns. The system exceeded all our requirements.", avatar: "https://i.pravatar.cc/80?u=gladys-jeruto-ke", rating: 5, isApproved: true },
      { name: "Henry Kiplagat", role: "Logistics Manager", text: "Fleet management has never been this efficient. Real-time tracking saved us hours of manual work.", avatar: "https://i.pravatar.cc/80?u=henry-kiplagat-ke", rating: 5, isApproved: true },
      { name: "Irene Achieng", role: "Retail Chain Owner", text: "Multi-store inventory system is now fully integrated. Stock management became effortless.", avatar: "https://i.pravatar.cc/80?u=irene-achieng-ke", rating: 5, isApproved: true },
      { name: "John Kioko", role: "Restaurant Group Owner", text: "The reservation and ordering system transformed our business. Online orders now make up 60% of revenue.", avatar: "https://i.pravatar.cc/80?u=john-kioko-ke", rating: 5, isApproved: true },
      { name: "Khadija Hassan", role: "Media Producer", text: "Content management became effortless. The team delivered exactly what we envisioned.", avatar: "https://i.pravatar.cc/80?u=khadija-hassan-ke", rating: 5, isApproved: true },
      { name: "Lawrence Mutua", role: "Manufacturing Lead", text: "Production tracking went digital. We now have real-time visibility across all factory lines.", avatar: "https://i.pravatar.cc/80?u=lawrence-mutua-ke", rating: 5, isApproved: true },
      { name: "Margaret Wairimu", role: "HR Director", text: "The HR management system simplified recruitment, payroll, and performance tracking. A complete game-changer.", avatar: "https://i.pravatar.cc/80?u=margaret-wairimu-ke", rating: 5, isApproved: true },
    ];
