      ...
      <section id="contact" className="section-pad bg-secondary bg-[url(/contact-bg.svg)]">
        <div className="container">
          <div className="max-w-lg mx-auto text-center">
            <div className="font-mono text-[12px] tracking-[0.2em] uppercase text-primary/50 mb-2">
              Message Received
            </div>
            <h2 className="heading-serif font-bold text-primary" style={{ fontSize: "clamp(1.1rem, 2.5vw, 1.5rem)" }}>
              I&apos;ll be in touch within 24 hours.
            </h2>
            <p className="font-mono text-[12px] tracking-[0.15em] text-primary/60 mt-3">
      ...
      <div className="container">
        <div className="max-w-lg mx-auto">
          ...
          <h2 className="heading-serif font-bold text-primary mt-2" style={{ fontSize: "clamp(1.1rem, 2.5vw, 1.5rem)" }}>
            ...
            <span className="italic font-light block text-[13px]"> worth talking about.</span>
          </h2>
          ...
          <div className="mt-3">
            <div className="flex items-center gap-1.5 mb-1">
              ...
              <span className="font-mono text-[12px] tracking-[0.15em] text-primary/60 shrink-0 ml-1">
                {step + 1} / 4
              </span>
            </div>

            <div className="font-mono text-[12px] tracking-[0.15em] uppercase text-primary/40 mb-3">
              {formSteps[step].subtitle}
            </div>
          </div>

          {error && (
            <div className="mb-2 p-1.5 bg-primary text-accent font-mono text-[12px]">
              {error}
            </div>
          )}
...
className={`font-mono text-[12px] tracking-[0.15em] uppercase px-2 py-1 border border-primary/20 transition-colors ${
                           projectType === type
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="flex justify-between mt-0.5">
                        <span className="font-mono text-[12px] text-primary/40">KSh 10k</span>
                        <span className="font-mono text-[12px] text-primary/40">KSh 500k+</span>
                      </div>
                    </div>
                    <div>
                      <div className="font-mono text-[12px] tracking-[0.15em] uppercase text-primary/40 mb-1.5">
                        Timeline
                      </div>
                      <div className="flex flex-wrap gap-1.5">
...
className={`font-mono text-[12px] tracking-[0.15em] uppercase px-2 py-1 border border-primary/20 transition-colors ${
                ...
                {step === 3 && (
                  <div>
                    ...
                    />
                    <div className="font-mono text-[12px] tracking-[0.15em] text-primary/40 mt-1">
...
className={`font-mono text-[12px] tracking-[0.15em] uppercase px-2 py-1 transition-colors ${
                   canContinue()
