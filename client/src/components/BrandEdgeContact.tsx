        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="mt-3">
            <div className="flex items-center gap-1.5 mb-1">
              ...
              <span className="font-mono text-[11px] tracking-[0.15em] text-primary/60 shrink-0 ml-1">
                {step + 1} / 4
              </span>
            </div>
          ...
          {error && (
            <div className="mb-2 p-1.5 bg-primary text-accent font-mono text-[11px]">
              {error}
            </div>
          )}
...
className={`font-mono text-[11px] tracking-[0.15em] uppercase px-2 py-1 border border-primary/20 transition-colors ${
                           projectType === type
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="flex justify-between mt-0.5">
                        <span className="font-mono text-[11px] text-primary/40">KSh 10k</span>
                        <span className="font-mono text-[11px] text-primary/40">KSh 500k+</span>
                      </div>
                    </div>
                    <div>
                      <div className="font-mono text-[11px] tracking-[0.15em] uppercase text-primary/40 mb-1.5">
                        Timeline
                      </div>
                      <div className="flex flex-wrap gap-1.5">
...
className={`font-mono text-[11px] tracking-[0.15em] uppercase px-2 py-1 border border-primary/20 transition-colors ${
                ...
                {step === 3 && (
                  <div>
                    ...
                    />
                    <div className="font-mono text-[11px] tracking-[0.15em] text-primary/40 mt-1">
...
className={`font-mono text-[11px] tracking-[0.15em] uppercase px-2 py-1 transition-colors ${
                   canContinue()
