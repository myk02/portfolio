...
import { handleSiteNav } from "@/lib/navigation";

interface SiteHeaderProps {
  onNavClick?: (id: string) => void;
}

export default function SiteHeader({ onNavClick }: SiteHeaderProps) {
  ...
  /* Return focus to the menu button when the menu closes (a11y) */
  useEffect(() => {
