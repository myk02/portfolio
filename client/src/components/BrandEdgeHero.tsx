    ...
    >
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="flex-1 py-8 lg:py-0">
            ...
            <motion.p
              ...
              className="text-secondary/60 font-sans text-[17px] leading-relaxed max-w-lg mt-3"
            >
      ...
      >
        <div className="scroll-indicator">
          <span className="font-mono text-[13px] tracking-[0.4em] text-secondary/50">SCROLL</span>
