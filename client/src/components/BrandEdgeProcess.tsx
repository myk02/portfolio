...
function ProcessStep({
  ...
  return (
    <motion.div style={{ opacity }} className="border-t border-secondary/10 pt-10 pb-8">
      <div className="grid grid-cols-12 gap-4 lg:gap-6">
        <div className="col-span-1">
          <span className="font-mono text-[11px] tracking-wider text-accent">{step.number}</span>
        </div>
        <div className="col-span-3 lg:col-span-3">
            <h3 className="font-display font-bold text-secondary" style={{ fontSize: "clamp(1.1rem, 2vw, 1.5rem)" }}>
              {step.title}
            </h3>
      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-12">
          <div>
            ...
            <h2 className="heading-serif font-bold text-secondary" style={{ fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)" }}>
              Three steps.
