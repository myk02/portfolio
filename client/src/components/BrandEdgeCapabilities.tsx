      ...
      <div className="container">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-1.5 mb-3">
          <div>
            ...
            <h2 className="heading-serif font-bold text-foreground" style={{ fontSize: "clamp(0.9rem, 2vw, 1.3rem)" }}>
              Six services.
              <span className="italic font-light text-muted-foreground block text-[11px]"> One focus — results.</span>
            </h2>
          </div>
          <p className="text-[13px] text-muted-foreground max-w-[200px] leading-relaxed lg:text-right">
              ...
              <div key={cap.id} className="border-b border-border">
                ...
                >
                  <div className="flex items-center gap-2 lg:gap-4">
                    <span className="font-mono text-[12px] tracking-wider text-muted-foreground w-5 shrink-0">
                      {cap.number}
                    </span>
                  ...
                  {isOpen && (
                    ...
                    >
                      <div className="pb-2 lg:pb-3 pl-7 lg:pl-8 pr-6">
                        <p className="text-[13px] text-muted-foreground leading-relaxed mb-2 max-w-2xl">
                          {cap.description}
                        </p>
                        <div className="flex flex-wrap gap-1">
                          {cap.tags.map((tag) => (
                            <span
                              key={tag}
                              className="font-mono text-[11px] tracking-[0.15em] uppercase px-1.5 py-0.5 border border-border"
                            >
                              {tag}
                            </span>
                          ))}
