...
function PhoneFrame({
  ...
  return (
    <div
      className={`relative bg-[#141310] rounded-soft p-1.5 shadow-[0_24px_60px_-20px_rgba(20,19,16,0.45)] ${className}`}
    >
      <div
        className="relative overflow-hidden rounded-[10px] bg-[#f4efe7]"
  ...
  return (
    <div className={`relative flex items-center justify-center ${className}`}>
      <motion.div
        ...
        className="w-[46%] min-w-[130px] max-w-[200px] -ml-2 sm:-ml-4 opacity-90 z-10 rotate-[-6deg]"
        aria-hidden
      >
        <PhoneFrame>
      ...
      <motion.div
        ...
        className="w-[52%] min-w-[150px] max-w-[220px] z-20"
      >
        <PhoneFrame>
          <div className="flex flex-col h-full">
            <StatusBar />
              ...
              <div className="mt-1 space-y-1">
                {[
                  ...
                  <div key={title as string} className="flex items-center gap-1.5">
                    ...
                    <span className={`text-[7.5px] font-bold ${pos ? "" : ""}`} style={{ color: pos ? "#1a7f37" : ink }}>
                      {amount}
                    </span>
                  </div>
                ))}
